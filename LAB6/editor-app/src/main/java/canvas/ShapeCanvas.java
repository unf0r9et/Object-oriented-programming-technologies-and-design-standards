...
public class ShapeCanvas extends JPanel {
    ...
    /**
     * Attaches the observer subject for shape-count notifications.
     */
    public void setCanvasSubject(CanvasSubject subject) {
        this.canvasSubject = subject;
    }

    private void notifyObservers() {
        if (canvasSubject != null) {
            canvasSubject.notifyShapeCount(shapes.size());
        }
    }
